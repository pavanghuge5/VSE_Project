    ...
    <div style={containerStyle}>
      <div style={searchContainerStyle}>
        ...
        <div style={{ display: 'flex', marginBottom: '1rem' }}>
          ...
          />
          <button
            style={{ marginLeft: '0.5rem', padding: '0.5rem 1rem', border: 'none', borderRadius: '4px',
          ...
          vehicles.map((vehicle, index) => (
            <div key={index} style={{ border: '1px solid #ddd', borderRadius: '4px', marginTop: '1rem' }}>
              ...
              <div style={{ padding: '1rem' }}>
                ...
                <p><strong>Company Name:</strong> {vehicle.company.companyName} 
                  <strong>Model Name:</strong> {vehicle.model.modelName}</p>                
                <p><strong>Category Name:</strong> {vehicle.category.categoryName}  
                <strong>SubCategory Name:</strong> {vehicle.subCategory.subCategoryName}</p>                

                <p><strong>Seller Name:</strong> {vehicle.seller.fname} {vehicle.seller.lname}</p>            
                <p><strong>Registration Year:</strong> {vehicle.registrationYear}
                <strong>Kms Driven:</strong> {vehicle.kmsDriven}
                <strong>Fuel Type:</strong> {vehicle.fuelType}</p>
