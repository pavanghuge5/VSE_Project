...
function AddVehicle() {
    ...
    const handleCompanyChange = (e) => {
        ...
        setFormData(prevData => ({ ...prevData, companyId: selectedCompanyId }));

        // Fetch models based on the selected company
        axios.get(`http://localhost:8080/api/models/company/${selectedCompanyId}`)
            .then(response => setModels(response.data))
            .catch(error => console.error('There was an error fetching models!', error));
    };
                        ...
                        <div className="row">
                            <div className="col-md-6">
                                <div className="mb-3">
                                    ...
                                    <select className="form-control" name="companyId" value={formData.companyId} onChange={handleCompanyChange} required>
                                ...
                                <div className="mb-3">
                                    ...
                                    <select className="form-control" name="modelId" value={formData.modelId} onChange={handleChange} required>
